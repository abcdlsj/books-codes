    ...
    gettime(&hi0, &lo0);
    {
        ...
        for (k = 0; k < it; k++)
        {
            ...
            for (j = 0; j < l; j++)
            {
                ...
                while (i <= nn - 3)
                {
                    /* that addition doesn't make much sense, but we don't care
                     * about the result... */
    ...
    gettime(&hi0, &lo0);
    {
        ...
        for (k = 0; k < it; k++)
        {
            ...
            for (j = 0; j < l; j++)
            {
                ...
                while (i <= nn - 2)
                {
                    /* we try to store a float zero value. Not sure if it really
                    works, it should not be assumed that the floating point
                    register value is preserved and that gcc is
                    happy about it. But it doesn't really matter here what is
                    stored */
                    __asm__ __volatile__("
                                             movntq %
                                             % mm0,
